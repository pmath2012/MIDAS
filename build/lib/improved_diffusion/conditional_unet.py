...
class ConditionalUNet(UNetModel):
    def __init__(self, in_channels, model_channels, out_channels, num_res_blocks, attention_resolutions, 
        ...
        super(ConditionalUNet, self).__init__(
            in_channels=in_channels + 3,  # +1 for mask channel +1 for conditioning channel
    ...
    def forward(self, x, timesteps, t0, mask, lesion_load, num_lesions, lesion):
        ...
        #print("combined_channel shape:", combined_channel.shape)
        x = torch.cat([t0, x, mask, combined_channel], dim=1)
